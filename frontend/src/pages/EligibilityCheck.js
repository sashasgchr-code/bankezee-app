      ...
      <div className="bg-white border-b sticky top-0 z-10 shadow-sm">
        <div className="max-w-[1200px] mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Button variant="ghost" size="sm" onClick={() => navigate(`/crm/lead/${leadId}`)} data-testid="back-btn">
              ...
              <CardContent className="py-3">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <Button variant="outline" size="sm" className="mt-2 h-7 text-xs border-amber-300 text-amber-700 hover:bg-amber-100" onClick={() => navigate(`/crm/lead/${leadId}`)}>
