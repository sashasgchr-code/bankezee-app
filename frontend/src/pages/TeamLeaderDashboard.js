...
import { Users, LogOut, LayoutDashboard, Eye, Key, TrendingUp, UserCheck, Briefcase, Search } from 'lucide-react';
...
const TeamLeaderDashboard = () => {
  ...
  const [team, setTeam] = useState({ agents: [], partners: [] });
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <nav className="bg-white border-b border-slate-200 px-6 py-4 flex justify-between items-center sticky top-0 z-50">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-bold" style={{ fontFamily: 'Manrope, sans-serif' }}>Team Leader Dashboard</h1>
        </div>
        <div className="flex items-center gap-3">
          ...
          <TabsContent value="dashboard">
            ...
            <Card data-testid="leads-list-card">
              <CardHeader>
                ...
                <CardDescription>View-only access to leads from your direct reports</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="team">
            ...
            <Card className="mb-6">
              <CardHeader>
                ...
                <CardDescription>Sales agents under your supervision</CardDescription>
              </CardHeader>
              <CardContent>
                {team.agents.length === 0 ? (
                  <p className="text-center py-4 text-slate-500">No agents mapped to you yet</p>
                ) : (
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Retail partners under your supervision</CardDescription>
              </CardHeader>
              <CardContent>
                {team.partners.length === 0 ? (
                  <p className="text-center py-4 text-slate-500">No partners mapped to you yet</p>
                ) : (
                  <div className="space-y-3">
